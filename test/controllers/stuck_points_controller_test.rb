...
class StuckPointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stuck_point" do
    assert_difference("StuckPoint.count") do
      post stuck_points_url, params: { stuck_point: { belief: @stuck_point.belief, belief_type: @stuck_point.belief_type, resolved: @stuck_point.resolved, title: @stuck_point.title, trauma_id: @stuck_point.trauma_id } }
    end
  ...
  test "should update stuck_point" do
    patch stuck_point_url(@stuck_point), params: { stuck_point: { belief: @stuck_point.belief, belief_type: @stuck_point.belief_type, resolved: @stuck_point.resolved, title: @stuck_point.title, trauma_id: @stuck_point.trauma_id } }
